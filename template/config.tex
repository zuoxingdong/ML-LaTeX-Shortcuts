...
\newcommand{\Lemmaref}[1]{Lemma~\ref{#1}}   % Lemma reference
...
\newcommand{\Prob}{\mathrm{P}}      % Probability
...
\newcommand{\pdd}{\partial}      % Partial derivative
...
\newcommand{\outers}[1]{ \left( {#1} \right) \left( {#1} \right)^T }
% trace
